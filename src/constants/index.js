...
export const heroText = {
  ...
  description: 'We are a tech company that provides the necessary tech building blocks to answer how to get your ideas to life. Our team is dedicated to delivering high-quality solutions that meet your business needs.',
...
export const processes = [
  {
    ...
    description: 'We will solidify a checklist of everything you want in your new mobile app. We will gather information about your current paper based performance recording data  and how it works. We’ll figure out the best way the data entry process is presented to the audience focusing on usability.'
  },
  {
    title: 'Framework',
  ...
  {
    title: 'Development',
    description: 'Our team of developers will start on the finalised designs. App developer will start on bring the UI to life, while our backend developers will design and develop the necessary database and apis'
  },
  {
    title: 'Testing and Pilot',
    description: 'Once the beta version of the app is ready,  rigorous testing and QA will be performed by the team. We will then proceed to bring in a small group of intended users to test and provide feedback. Based on the changes required we will proceed with final launch of the app'
  },
  {
    title: 'Deployment and Support',
    description: 'App is launched to final users. Source code and other assets are handed over to you. This is when our support period starts to ensure app operates as it should.'
  },
];
